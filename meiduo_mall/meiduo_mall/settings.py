...
Generated by 'django-admin_manage startproject' using Django 3.2.12.
...
SECRET_KEY = 'django-insecure-idjr748hm5qsfzozwfq8@g6k7jq#pop*)2n(253qynr@hvr^rz'
...
JWT_AUTH = {
    ...
    # 'rest_framework_jwt.utils.jwt_response_payload_handler',
        'apps.admin_manage.user.jwt_response_payload_handler',
    # 修改token的过期时间
