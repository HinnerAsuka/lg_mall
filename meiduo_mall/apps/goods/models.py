...
class SpecificationOption(BaseModel):
    ...
    class Meta:
        db_table = 'lg_specification_option'
        verbose_name = '规格选项'
        verbose_name_plural = verbose_name
